<html><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initital-scale=1"/>
<title>폼 학습</title></head>
<body><section><h2>JSP form</h2>
 <section><h2>이름/이메일</h2>
  <h2>이름:<%=request.getParameter("stud_name")%>, 이메일:<%=request.getParameter("stud_email")%>, 전화:<%=request.getParameter("stdu_phone")%><br/></h2>
  <h2>아이디/비밀번호</h2>
